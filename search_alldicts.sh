curl -X POST \
  'http://localhost:8990/solr/filteredDictCorpusAllDicts/tag?overlaps=LONGEST_DOMINANT_RIGHT&matchText=true&tagsLimit=5000&fl=uuid,icd10,term&wt=json&indent=on' \
